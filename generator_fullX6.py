...
ceilWidt 	= imageWidth*0.16666
ceilHeight 	= ceilWidt*0.32
xst 		= int(imageWidth*(20/float(paperWidth)))
yst 		= int(imageWidth*(20/float(paperWidth)))
...
while i<78:
	printYear(bYear+i,bYear,xst+ystlb*ceilWidt,yst+ystr*ceilHeight,ceilWidt*0.7,draw)
	i 		+= 1
	ystlb	+= 1
	if ystlb > 5:
		ystlb 	=  0
